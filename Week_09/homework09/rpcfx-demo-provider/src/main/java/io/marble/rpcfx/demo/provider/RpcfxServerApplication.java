...
import io.marble.rpcfx.api.ServiceProviderDesc;
import io.marble.rpcfx.demo.api.OrderService;
import io.marble.rpcfx.demo.api.UserService;
import io.marble.rpcfx.server.RpcfxInvoker;
...
//		String userService = "io.marble.rpcfx.demo.api.UserService";
//		registerService(client, userService);
//		String orderService = "io.marble.rpcfx.demo.api.OrderService";
//		registerService(client, orderService);
	...
	@Bean(name = "io.marble.rpcfx.demo.api.UserService")
	public UserService createUserService(){
		return new UserServiceImpl();
	}

	@Bean(name = "io.marble.rpcfx.demo.api.OrderService")
